...
from .models import AdvUser, Bb, AdditionalImage, SuperRubric, SubRubric
import datetime
...
class NonactivatedFilter(admin.SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        ...
        if val == 'activated':
            ...
            return queryset.filter(is_active=False, user_is_activated=False,
                                   date_joined__date__lt=d)
...
class BbAdmn(admin.ModelAdmin):
    list_display = ('rubric', 'title', 'content', 'author', 'created_at')
    fields = (('rubric', 'author'), 'title', 'content', 'price', 'contacts', 'image', 'is_active')
    inlines = (AdditionalImageInline,)

admin.site.register(Bb, BbAdmn)
